...
-- 2 - Selecione as composices e o tempo de cada composicao, de todos os registros da tabela musicas, onde o tempo seja maior que 4 minutos.
...
SELECT id, compositor FROM musicas where id >47 and id<123;
...
SELECT compositor,tempo FROM musicas WHERE compositor IN ('Mozart', 'Bach');
...
SELECT * FROM musicas	limit 10 offset 50;
